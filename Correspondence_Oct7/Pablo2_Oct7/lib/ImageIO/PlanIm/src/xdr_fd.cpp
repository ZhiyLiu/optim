...
static u_int	xdrfd_getpos(CONST2 XDR *);
...
xdrfd_flush_buff(XDR *xdrs)
{
	...
	fprintf(stderr, "bad write: %d %x %d\n", 
...
#ifndef WIN32
	XDR::xdr_ops* ops = (XDR::xdr_ops*)(xdrs->x_ops);
    ops->x_getlong = (bool_t(*)(XDR*, long int*))xdrfd_getlong;
    ops->x_putlong = (bool_t(*)(XDR*, const long int*))xdrfd_putlong;
    ops->x_getbytes = (bool_t(*)(XDR*, char*, unsigned int))xdrfd_getbytes;
    ops->x_putbytes = (bool_t(*)(XDR*,const char*, unsigned int))xdrfd_putbytes;
    ops->x_getpostn = (u_int(*)(const XDR*))xdrfd_getpos;
#else	
	XDR::xdr_ops* ops = (XDR::xdr_ops*)(xdrs->x_ops);
    ops->x_getlong = xdrfd_getlong;
    ops->x_putlong = xdrfd_putlong;
    ops->x_getbytes = xdrfd_getbytes;
    ops->x_putbytes = xdrfd_putbytes;
    ops->x_getpostn = xdrfd_getpos;
#endif


    ops->x_setpostn = xdrfd_setpos;
    ops->x_inline = NULL;
    ops->x_destroy = xdrfd_destroy;
