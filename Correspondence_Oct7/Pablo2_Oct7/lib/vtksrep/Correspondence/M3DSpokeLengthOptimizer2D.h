...
#ifndef M3DSPOKELENGTHOPTIMIZER2D_H
#define M3DSPOKELENGTHOPTIMIZER2D_H
...
class M3DSpokeLengthOptimizer2D
{
public:
    M3DSpokeLengthOptimizer2D();

    M3DSpokeLengthOptimizer2D(M3DObject* sreps);
