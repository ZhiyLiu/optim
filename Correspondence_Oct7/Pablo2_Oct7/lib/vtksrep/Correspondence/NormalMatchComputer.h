/* The purpose of this class is to compute image normal match
 * and spoke normal computer
 *
 * Zhiyuan Liu
 * 2018.02
 */
#ifndef _NORMALMATCHCOMPUTER_H_
#define _NORMALMATCHCOMPUTER_H_
