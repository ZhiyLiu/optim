...
//        const char * maskFilename, bool useWindowing = true);
    ...
    double computeAtomBinaryImageNormalMatch( M3DObject * targetObject, int figureId, int atomId );

	// dibyendu - adding the function only for the spoke and its neighbors

	double computeSpokeBinaryImageNormalMatch( M3DObject * targetObject, int figureId, int atomId, int spokeId );
