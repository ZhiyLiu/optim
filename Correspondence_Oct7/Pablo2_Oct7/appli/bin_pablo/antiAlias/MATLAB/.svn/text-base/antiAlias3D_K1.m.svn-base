function phi = antiAlias3D_K1(img, verbose, movementThreshold, bandwidth, maxIterations, spacing)
%
% Uses alternate min(K2,0), max(K1,0) flow.
%
...
while iter < maxIterations
	...
	if( verbose >= 1 )
 	...
 	phi(i000) = max(min(phi(i000) + dt*update, phi0 + movementThreshold), phi0 - movementThreshold);
